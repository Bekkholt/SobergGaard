...
<div class="m-5 p-2 max-w-sm bg-lime-950 border border-gray-800 rounded-lg dark:bg-gray-800 dark:border-gray-700 shadow-xl">
    ...
    <div class="p-5">
        ...
        <a href="../../Pages/Om" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-orange-950 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-orange-950 dark:focus:ring-blue-800">
            Gå inn her
...
<div class="m-5 p-2 max-w-sm bg-lime-950 border border-gray-800 rounded-lg dark:bg-gray-800 dark:border-gray-700 shadow-xl">
    ...
    <div class="p-5">
        ...
        <p class="mb-3 tiktok-sans-text text-color dark:text-gray-900">Tekst som hører til på kortet. Bilde, tittel og knapp kan trykkes på for mer informasjon.</p>
        <a href="../../Pages/BestillTime" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-orange-950 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-orange-950 dark:focus:ring-blue-800">
            Gå inn her
             <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
            </svg>
...
<div class="m-5 p-2 max-w-sm bg-lime-950 border border-gray-800 rounded-lg dark:bg-gray-800 dark:border-gray-700 shadow-xl">
    ...
    <div class="p-5">
        ...
        <p class="mb-3 tiktok-sans-text text-color dark:text-gray-900">Tekst som hører til på kortet. Bilde, tittel og knapp kan trykkes på for mer informasjon.</p>
        <a href="../../Pages/FAQ" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-green-700 rounded-lg hover:bg-orange-950 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-orange-950 dark:focus:ring-blue-800">
            Gå inn her
             <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5h12m0 0L9 1m4 4L9 9"/>
            </svg>
